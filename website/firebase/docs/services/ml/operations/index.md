...
<tr><td><b>Id</b></td><td><CopyableCode code="firebase.ml.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM firebase.ml.operations
...
```sql
EXEC firebase.ml.operations.operations_cancel 
