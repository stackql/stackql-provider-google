...
<tr><td><b>Id</b></td><td><CopyableCode code="google.securesourcemanager.instances_iam_policies" /></td></tr>
</tbody></table>
...
etag,
version
FROM google.securesourcemanager.instances_iam_policies
...
```sql
REPLACE google.securesourcemanager.instances_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.securesourcemanager.instances_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
