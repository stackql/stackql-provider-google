...
Creates, updates, deletes, gets or lists an <code>artifacts_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>artifacts_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.apigeeregistry.artifacts_iam_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="projects_locations_apis_versions_specs_artifacts_get_iam_policy"
    values={[
        { label: 'projects_locations_apis_versions_specs_artifacts_get_iam_policy', value: 'projects_locations_apis_versions_specs_artifacts_get_iam_policy' },
        { label: 'projects_locations_apis_versions_artifacts_get_iam_policy', value: 'projects_locations_apis_versions_artifacts_get_iam_policy' },
        { label: 'projects_locations_apis_artifacts_get_iam_policy', value: 'projects_locations_apis_artifacts_get_iam_policy' },
        { label: 'projects_locations_artifacts_get_iam_policy', value: 'projects_locations_artifacts_get_iam_policy' }
    ]}
>
...
<tbody>
<tr>
    <td><a href="#projects_locations_apis_versions_specs_artifacts_get_iam_policy"><CopyableCode code="projects_locations_apis_versions_specs_artifacts_get_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_apis_versions_artifacts_get_iam_policy"><CopyableCode code="projects_locations_apis_versions_artifacts_get_iam_policy" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    <td><a href="#projects_locations_apis_artifacts_get_iam_policy"><CopyableCode code="projects_locations_apis_artifacts_get_iam_policy" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    <td><a href="#projects_locations_artifacts_get_iam_policy"><CopyableCode code="projects_locations_artifacts_get_iam_policy" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    <td><a href="#projects_locations_apis_versions_specs_artifacts_set_iam_policy"><CopyableCode code="projects_locations_apis_versions_specs_artifacts_set_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_apis_versions_artifacts_set_iam_policy"><CopyableCode code="projects_locations_apis_versions_artifacts_set_iam_policy" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-apisId"><code>apisId</code></a>, <a href="#parameter-versionsId"><code>versionsId</code></a>, <a href="#parameter-artifactsId"><code>artifactsId</code></a></td>
    <td></td>
    <td>Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.</td>
...
<tr>
    <td><a href="#projects_locations_apis_artifacts_set_iam_policy"><CopyableCode code="projects_locations_apis_artifacts_set_iam_policy" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-apisId"><code>apisId</code></a>, <a href="#parameter-artifactsId"><code>artifactsId</code></a></td>
    <td></td>
    <td>Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.</td>
...
<tr>
    <td><a href="#projects_locations_artifacts_set_iam_policy"><CopyableCode code="projects_locations_artifacts_set_iam_policy" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-artifactsId"><code>artifactsId</code></a></td>
    <td></td>
    <td>Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.</td>
...
<tr>
    <td><a href="#projects_locations_apis_artifacts_test_iam_permissions"><CopyableCode code="projects_locations_apis_artifacts_test_iam_permissions" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-apisId"><code>apisId</code></a>, <a href="#parameter-artifactsId"><code>artifactsId</code></a></td>
    <td></td>
    <td>Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.</td>
...
<Tabs
    defaultValue="projects_locations_apis_versions_specs_artifacts_set_iam_policy"
    values={[
        { label: 'projects_locations_apis_versions_specs_artifacts_set_iam_policy', value: 'projects_locations_apis_versions_specs_artifacts_set_iam_policy' },
        { label: 'projects_locations_apis_versions_artifacts_set_iam_policy', value: 'projects_locations_apis_versions_artifacts_set_iam_policy' },
        { label: 'projects_locations_apis_artifacts_set_iam_policy', value: 'projects_locations_apis_artifacts_set_iam_policy' },
        { label: 'projects_locations_artifacts_set_iam_policy', value: 'projects_locations_artifacts_set_iam_policy' }
    ]}
>
<TabItem value="projects_locations_apis_versions_specs_artifacts_set_iam_policy">
...
<TabItem value="projects_locations_apis_versions_artifacts_set_iam_policy">
...
<TabItem value="projects_locations_apis_artifacts_set_iam_policy">
...
<TabItem value="projects_locations_artifacts_set_iam_policy">
...
```sql
EXEC google.apigeeregistry.artifacts_iam_policies.projects_locations_apis_versions_specs_artifacts_test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
...
```sql
EXEC google.apigeeregistry.artifacts_iam_policies.projects_locations_apis_versions_artifacts_test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@apisId='{{ apisId }}' --required, 
@versionsId='{{ versionsId }}' --required, 
