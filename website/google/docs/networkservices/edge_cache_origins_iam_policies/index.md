...
Creates, updates, deletes, gets or lists an <code>edge_cache_origins_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>edge_cache_origins_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.networkservices.edge_cache_origins_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-edgeCacheOriginsId"><code>edgeCacheOriginsId</code></a></td>
...
<tbody>
<tr id="parameter-edgeCacheOriginsId">
    <td><CopyableCode code="edgeCacheOriginsId" /></td>
...
AND edgeCacheOriginsId = '{{ edgeCacheOriginsId }}' -- required
...
```sql
REPLACE google.networkservices.edge_cache_origins_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.networkservices.edge_cache_origins_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@edgeCacheOriginsId='{{ edgeCacheOriginsId }}' --required 
@@json=
'{
