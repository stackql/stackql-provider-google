...
<tr><td><b>Id</b></td><td><CopyableCode code="google.translate.operations" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#projects_locations_operations_wait"><CopyableCode code="projects_locations_operations_wait" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-operationsId"><code>operationsId</code></a></td>
    <td></td>
...
<Tabs
    ...
    values={[
        ...
        { label: 'projects_locations_operations_wait', value: 'projects_locations_operations_wait' }
    ]}
>
...
```sql
EXEC google.translate.operations.projects_locations_operations_wait 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@operationsId='{{ operationsId }}' --required 
@@json=
