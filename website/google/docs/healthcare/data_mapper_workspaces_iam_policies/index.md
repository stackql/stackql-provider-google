...
Creates, updates, deletes, gets or lists a <code>data_mapper_workspaces_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>data_mapper_workspaces_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.healthcare.data_mapper_workspaces_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-datasetsId"><code>datasetsId</code></a>, <a href="#parameter-dataMapperWorkspacesId"><code>dataMapperWorkspacesId</code></a></td>
...
<tbody>
<tr id="parameter-dataMapperWorkspacesId">
    <td><CopyableCode code="dataMapperWorkspacesId" /></td>
...
etag,
version
FROM google.healthcare.data_mapper_workspaces_iam_policies
WHERE projectsId = '{{ projectsId }}' -- required
AND locationsId = '{{ locationsId }}' -- required
AND datasetsId = '{{ datasetsId }}' -- required
AND dataMapperWorkspacesId = '{{ dataMapperWorkspacesId }}' -- required
...
```sql
REPLACE google.healthcare.data_mapper_workspaces_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.healthcare.data_mapper_workspaces_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@datasetsId='{{ datasetsId }}' --required, 
@dataMapperWorkspacesId='{{ dataMapperWorkspacesId }}' --required 
@@json=
'{
