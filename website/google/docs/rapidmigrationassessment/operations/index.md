...
<tr><td><b>Id</b></td><td><CopyableCode code="google.rapidmigrationassessment.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.rapidmigrationassessment.operations
WHERE projectsId = '{{ projectsId }}' --required
AND locationsId = '{{ locationsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
...
```sql
EXEC google.rapidmigrationassessment.operations.cancel 
