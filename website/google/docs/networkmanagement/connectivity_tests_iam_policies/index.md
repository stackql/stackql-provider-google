...
keywords:
  - connectivity_tests_iam_policies
  - networkmanagement
  - google
...
Creates, updates, deletes, gets or lists a <code>connectivity_tests_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>connectivity_tests_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.networkmanagement.connectivity_tests_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.networkmanagement.connectivity_tests_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.networkmanagement.connectivity_tests_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
