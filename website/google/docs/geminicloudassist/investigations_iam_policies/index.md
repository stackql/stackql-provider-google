...
Creates, updates, deletes, gets or lists an <code>investigations_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>investigations_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.geminicloudassist.investigations_iam_policies" /></td></tr>
</tbody></table>
...
etag,
version
FROM google.geminicloudassist.investigations_iam_policies
...
```sql
REPLACE google.geminicloudassist.investigations_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.geminicloudassist.investigations_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
