...
<tr><td><b>Id</b></td><td><CopyableCode code="google.bigtableadmin.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.bigtableadmin.operations
WHERE operationsId = '{{ operationsId }}' --required;
```
</TabItem>
</Tabs>
...
```sql
EXEC google.bigtableadmin.operations.cancel 
