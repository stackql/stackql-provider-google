...
<tr><td><b>Id</b></td><td><CopyableCode code="google.spanner.instances_iam_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="projects_instances_get_iam_policy"
    values={[
        { label: 'projects_instances_get_iam_policy', value: 'projects_instances_get_iam_policy' }
    ]}
>
<TabItem value="projects_instances_get_iam_policy">
...
<tbody>
<tr>
    <td><a href="#projects_instances_get_iam_policy"><CopyableCode code="projects_instances_get_iam_policy" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-instancesId"><code>instancesId</code></a></td>
    <td></td>
    <td>Gets the access control policy for an instance resource. Returns an empty policy if an instance exists but does not have a policy set. Authorization requires `spanner.instances.getIamPolicy` on resource.</td>
</tr>
<tr>
    <td><a href="#projects_instances_set_iam_policy"><CopyableCode code="projects_instances_set_iam_policy" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-instancesId"><code>instancesId</code></a></td>
    <td></td>
    <td>Sets the access control policy on an instance resource. Replaces any existing policy. Authorization requires `spanner.instances.setIamPolicy` on resource.</td>
</tr>
<tr>
    <td><a href="#projects_instances_test_iam_permissions"><CopyableCode code="projects_instances_test_iam_permissions" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-instancesId"><code>instancesId</code></a></td>
    <td></td>
    <td>Returns permissions that the caller has on the specified instance resource. Attempting this RPC on a non-existent Cloud Spanner instance resource will result in a NOT_FOUND error if the user has `spanner.instances.list` permission on the containing Google Cloud Project. Otherwise returns an empty set of permissions.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="projects_instances_set_iam_policy"
    values={[
        { label: 'projects_instances_set_iam_policy', value: 'projects_instances_set_iam_policy' }
    ]}
>
<TabItem value="projects_instances_set_iam_policy">
...
<Tabs
    defaultValue="projects_instances_test_iam_permissions"
    values={[
        { label: 'projects_instances_test_iam_permissions', value: 'projects_instances_test_iam_permissions' }
    ]}
>
<TabItem value="projects_instances_test_iam_permissions">
...
```sql
EXEC google.spanner.instances_iam_policies.projects_instances_test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
