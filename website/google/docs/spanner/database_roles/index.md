...
<tr>
    ...
    <td>Database roles that matched the request.</td>
</tr>
<tr>
    <td><CopyableCode code="nextPageToken" /></td>
    <td><code>string</code></td>
    <td>`next_page_token` can be sent in a subsequent ListDatabaseRoles call to fetch more of the matching roles.</td>
</tr>
</tbody>
</table>
</TabItem>
