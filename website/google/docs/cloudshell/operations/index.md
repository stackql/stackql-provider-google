...
<tr><td><b>Id</b></td><td><CopyableCode code="google.cloudshell.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.cloudshell.operations
WHERE operationsId = '{{ operationsId }}' --required;
```
</TabItem>
</Tabs>
...
```sql
EXEC google.cloudshell.operations.cancel 
