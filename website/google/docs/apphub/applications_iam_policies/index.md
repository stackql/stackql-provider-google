...
<tr><td><b>Id</b></td><td><CopyableCode code="google.apphub.applications_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.apphub.applications_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.apphub.applications_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
