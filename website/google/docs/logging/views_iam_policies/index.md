...
Creates, updates, deletes, gets or lists a <code>views_iam_policies</code> resource.
...
<Tabs
    defaultValue="projects_locations_buckets_views_get_iam_policy"
    values={[
...
<Tabs
    defaultValue="projects_locations_buckets_views_set_iam_policy"
    values={[
...
<Tabs
    defaultValue="locations_buckets_views_test_iam_permissions"
    values={[
