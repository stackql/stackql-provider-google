...
<Tabs
    defaultValue="get_cmek_settings"
    values={[
        { label: 'get_cmek_settings', value: 'get_cmek_settings' }
    ]}
>
...
<tbody>
<tr>
    <td><a href="#get_cmek_settings"><CopyableCode code="get_cmek_settings" /></a></td>
...
<tr>
    <td><a href="#update_cmek_settings"><CopyableCode code="update_cmek_settings" /></a></td>
...
<Tabs
    defaultValue="update_cmek_settings"
    values={[
        { label: 'update_cmek_settings', value: 'update_cmek_settings' }
    ]}
>
<TabItem value="update_cmek_settings">
