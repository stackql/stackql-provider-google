...
<tr><td><b>Id</b></td><td><CopyableCode code="google.managedidentities.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.managedidentities.operations
WHERE projectsId = '{{ projectsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
</TabItem>
...
```sql
EXEC google.managedidentities.operations.cancel 
