...
Creates, updates, deletes, gets or lists a <code>managed_zones_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>managed_zones_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.dns.managed_zones_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-managedZonesId"><code>managedZonesId</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-managedZonesId">
    <td><CopyableCode code="managedZonesId" /></td>
...
```sql
REPLACE google.dns.managed_zones_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.dns.managed_zones_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@managedZonesId='{{ managedZonesId }}' --required 
@@json=
'{
