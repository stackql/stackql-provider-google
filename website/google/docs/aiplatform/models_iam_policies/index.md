...
<tr><td><b>Id</b></td><td><CopyableCode code="google.aiplatform.models_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.aiplatform.models_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.aiplatform.models_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
