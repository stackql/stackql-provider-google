--- 
title: feature_groups_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - feature_groups_iam_policies
  - aiplatform
  - google
...
Creates, updates, deletes, gets or lists a <code>feature_groups_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>feature_groups_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.aiplatform.feature_groups_iam_policies" /></td></tr>
</tbody></table>
...
etag,
version
FROM google.aiplatform.feature_groups_iam_policies
...
```sql
REPLACE google.aiplatform.feature_groups_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.aiplatform.feature_groups_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@featureGroupsId='{{ featureGroupsId }}' --required, 
