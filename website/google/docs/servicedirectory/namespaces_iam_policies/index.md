...
Creates, updates, deletes, gets or lists a <code>namespaces_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>namespaces_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.servicedirectory.namespaces_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets the IAM Policy for a resource (namespace or service only).</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-namespacesId"><code>namespacesId</code></a></td>
    <td></td>
    <td>Sets the IAM Policy for a resource (namespace or service only).</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-namespacesId"><code>namespacesId</code></a></td>
    <td></td>
    <td>Tests IAM permissions for a resource (namespace or service only).</td>
</tr>
</tbody>
</table>
...
```sql
REPLACE google.servicedirectory.namespaces_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.servicedirectory.namespaces_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
