...
<tr><td><b>Id</b></td><td><CopyableCode code="google.videointelligence.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.videointelligence.operations
WHERE projectsId = '{{ projectsId }}' --required
AND locationsId = '{{ locationsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
...
```sql
EXEC google.videointelligence.operations.projects_locations_operations_cancel 
