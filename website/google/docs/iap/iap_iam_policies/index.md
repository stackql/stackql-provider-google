...
Creates, updates, deletes, gets or lists an <code>iap_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>iap_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.iap.iap_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets the access control policy for an Identity-Aware Proxy protected resource. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-v1Id"><code>v1Id</code></a></td>
    <td></td>
    <td>Sets the access control policy for an Identity-Aware Proxy protected resource. Replaces any existing policy. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-v1Id"><code>v1Id</code></a></td>
    <td></td>
    <td>Returns permissions that a caller has on the Identity-Aware Proxy protected resource. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api</td>
</tr>
</tbody>
</table>
...
```sql
EXEC google.iap.iap_iam_policies.test_iam_permissions 
@v1Id='{{ v1Id }}' --required 
@@json=
'{
