...
Creates, updates, deletes, gets or lists a <code>service_connection_policies_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>service_connection_policies_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.networkconnectivity.service_connection_policies_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.networkconnectivity.service_connection_policies_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.networkconnectivity.service_connection_policies_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@serviceConnectionPoliciesId='{{ serviceConnectionPoliciesId }}' --required 
@@json=
'{
