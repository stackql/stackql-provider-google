...
<tr><td><b>Id</b></td><td><CopyableCode code="google.apigateway.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The error result of the operation in case of failure or cancellation. (id: ApigatewayStatus)</td>
</tr>
<tr>
...
```sql
EXEC google.apigateway.operations.cancel 
