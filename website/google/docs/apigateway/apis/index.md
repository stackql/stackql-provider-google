...
<tr>
    ...
    <td>Output only. Resource name of the API. Format: projects/&#123;project&#125;/locations/global/apis/&#123;api&#125;</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="managedService" /></td>
    <td><code>string</code></td>
    <td>Optional. Immutable. The name of a Google Managed Service ( https://cloud.google.com/service-infrastructure/docs/glossary#managed). If not specified, a new Service will automatically be created in the same project as this API.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets details of a single Api.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Creates a new Api in a given project and location.</td>
</tr>
<tr>
    ...
    <td>Updates the parameters of a single Api.</td>
</tr>
<tr>
