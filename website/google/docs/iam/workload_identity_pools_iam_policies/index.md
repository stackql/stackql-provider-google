--- 
title: workload_identity_pools_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - workload_identity_pools_iam_policies
  - iam
  - google
...
Creates, updates, deletes, gets or lists a <code>workload_identity_pools_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>workload_identity_pools_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.iam.workload_identity_pools_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets the IAM policy of a WorkloadIdentityPool.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-workloadIdentityPoolsId"><code>workloadIdentityPoolsId</code></a></td>
    <td></td>
    <td>Sets the IAM policies on a WorkloadIdentityPool</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-workloadIdentityPoolsId"><code>workloadIdentityPoolsId</code></a></td>
    <td></td>
    <td>Returns the caller's permissions on a WorkloadIdentityPool</td>
</tr>
</tbody>
</table>
...
etag,
version
FROM google.iam.workload_identity_pools_iam_policies
...
```sql
REPLACE google.iam.workload_identity_pools_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.iam.workload_identity_pools_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
