...
Creates, updates, deletes, gets or lists a <code>secrets_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>secrets_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.secretmanager.secrets_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Gets the access control policy for a secret. Returns empty policy if the secret exists and does not have a policy set.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-secretsId"><code>secretsId</code></a></td>
    <td></td>
    <td>Sets the access control policy on the specified secret. Replaces any existing policy. Permissions on SecretVersions are enforced according to the policy set on the associated Secret.</td>
</tr>
<tr>
...
```sql
EXEC google.secretmanager.secrets_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
