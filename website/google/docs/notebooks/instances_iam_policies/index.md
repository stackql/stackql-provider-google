...
<tr><td><b>Id</b></td><td><CopyableCode code="google.notebooks.instances_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.notebooks.instances_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.notebooks.instances_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
