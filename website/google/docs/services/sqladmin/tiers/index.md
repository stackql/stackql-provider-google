...
Creates, updates, deletes, gets or lists a <code>tiers</code> resource.
...
<tr>
    ...
    <td>This is always `sql#tiersList`.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists all available machine types (tiers) for Cloud SQL, for example, `db-custom-1-3840`. For more information, see https://cloud.google.com/sql/pricing.</td>
</tr>
</tbody>
</table>
