...
Creates, updates, deletes, gets or lists a <code>volume_restores_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>volume_restores_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.gkebackup.volume_restores_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.gkebackup.volume_restores_iam_policies
...
```sql
REPLACE google.gkebackup.volume_restores_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.gkebackup.volume_restores_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@restorePlansId='{{ restorePlansId }}' --required, 
@restoresId='{{ restoresId }}' --required, 
@volumeRestoresId='{{ volumeRestoresId }}' --required 
@@json=
'{
