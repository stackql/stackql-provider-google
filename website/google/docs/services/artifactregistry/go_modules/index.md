...
Creates, updates, deletes, gets or lists a <code>go_modules</code> resource.
...
<tr>
    ...
    <td></td>
    <td>Directly uploads a Go module. The returned Operation will complete once the Go module is uploaded. Package, Version, and File resources are created based on the uploaded Go module.</td>
</tr>
</tbody>
</table>
