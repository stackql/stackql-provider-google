...
Creates, updates, deletes, gets or lists a <code>notes_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>notes_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.containeranalysis.notes_iam_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="projects_locations_notes_get_iam_policy"
    values={[
        { label: 'projects_locations_notes_get_iam_policy', value: 'projects_locations_notes_get_iam_policy' },
        { label: 'projects_notes_get_iam_policy', value: 'projects_notes_get_iam_policy' }
    ]}
>
<TabItem value="projects_locations_notes_get_iam_policy">
...
<TabItem value="projects_notes_get_iam_policy">
...
<tbody>
<tr>
    <td><a href="#projects_locations_notes_get_iam_policy"><CopyableCode code="projects_locations_notes_get_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_notes_get_iam_policy"><CopyableCode code="projects_notes_get_iam_policy" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    <td><a href="#projects_locations_notes_set_iam_policy"><CopyableCode code="projects_locations_notes_set_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_notes_set_iam_policy"><CopyableCode code="projects_notes_set_iam_policy" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-notesId"><code>notesId</code></a></td>
    <td></td>
    <td>Sets the access control policy on the specified note or occurrence. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or an occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences.</td>
...
<Tabs
    defaultValue="projects_locations_notes_set_iam_policy"
    values={[
        { label: 'projects_locations_notes_set_iam_policy', value: 'projects_locations_notes_set_iam_policy' },
        { label: 'projects_notes_set_iam_policy', value: 'projects_notes_set_iam_policy' }
    ]}
>
<TabItem value="projects_locations_notes_set_iam_policy">

Sets the access control policy on the specified note or occurrence. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or an occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences.

```sql
REPLACE google.containeranalysis.notes_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
<TabItem value="projects_notes_set_iam_policy">
