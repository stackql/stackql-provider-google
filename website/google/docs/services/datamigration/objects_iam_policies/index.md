...
<tr><td><b>Id</b></td><td><CopyableCode code="google.datamigration.objects_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.datamigration.objects_iam_policies
...
```sql
REPLACE google.datamigration.objects_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.datamigration.objects_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
