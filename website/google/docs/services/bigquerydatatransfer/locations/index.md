...
<tr>
    <td><a href="#projects_locations_enroll_data_sources"><CopyableCode code="projects_locations_enroll_data_sources" /></a></td>
...
<tr>
    <td><a href="#projects_locations_unenroll_data_sources"><CopyableCode code="projects_locations_unenroll_data_sources" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a></td>
    <td></td>
    <td>Unenroll data sources in a user project. This allows users to remove transfer configurations for these data sources. They will no longer appear in the ListDataSources RPC and will also no longer appear in the [BigQuery UI](https://console.cloud.google.com/bigquery). Data transfers configurations of unenrolled data sources will not be scheduled.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="projects_locations_enroll_data_sources"
    values={[
        { label: 'projects_locations_enroll_data_sources', value: 'projects_locations_enroll_data_sources' },
        { label: 'projects_locations_unenroll_data_sources', value: 'projects_locations_unenroll_data_sources' }
    ]}
>
<TabItem value="projects_locations_enroll_data_sources">
...
```sql
EXEC google.bigquerydatatransfer.locations.projects_locations_unenroll_data_sources 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required 
@@json=
'{
