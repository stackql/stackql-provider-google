--- 
title: interconnect_attachment_groups_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - interconnect_attachment_groups_iam_policies
  - compute
  - google
...
Creates, updates, deletes, gets or lists an <code>interconnect_attachment_groups_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>interconnect_attachment_groups_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.interconnect_attachment_groups_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.compute.interconnect_attachment_groups_iam_policies
...
```sql
REPLACE google.compute.interconnect_attachment_groups_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.compute.interconnect_attachment_groups_iam_policies.test_iam_permissions 
@project='{{ project }}' --required, 
