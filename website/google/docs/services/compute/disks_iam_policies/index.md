...
Creates, updates, deletes, gets or lists a <code>disks_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>disks_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.disks_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.compute.disks_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.compute.disks_iam_policies.test_iam_permissions 
@project='{{ project }}' --required, 
