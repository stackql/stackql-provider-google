...
Creates, updates, deletes, gets or lists a <code>rag_file_operations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>rag_file_operations</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.aiplatform.rag_file_operations" /></td></tr>
</tbody></table>
...
metadata,
response
FROM google.aiplatform.rag_file_operations
...
```sql
DELETE FROM google.aiplatform.rag_file_operations
WHERE projectsId = '{{ projectsId }}' --required
AND locationsId = '{{ locationsId }}' --required
AND ragCorporaId = '{{ ragCorporaId }}' --required
AND ragFilesId = '{{ ragFilesId }}' --required
...
```sql
EXEC google.aiplatform.rag_file_operations.wait 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@ragCorporaId='{{ ragCorporaId }}' --required, 
@ragFilesId='{{ ragFilesId }}' --required, 
