--- 
title: kafka_sources_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - kafka_sources_iam_policies
  - eventarc
  - google
...
Creates, updates, deletes, gets or lists a <code>kafka_sources_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>kafka_sources_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.eventarc.kafka_sources_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-kafkaSourcesId"><code>kafkaSourcesId</code></a></td>
...
<tbody>
<tr id="parameter-kafkaSourcesId">
    <td><CopyableCode code="kafkaSourcesId" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
...
members,
role
FROM google.eventarc.kafka_sources_iam_policies
WHERE projectsId = '{{ projectsId }}' -- required
AND locationsId = '{{ locationsId }}' -- required
AND kafkaSourcesId = '{{ kafkaSourcesId }}' -- required
...
```sql
REPLACE google.eventarc.kafka_sources_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.eventarc.kafka_sources_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@kafkaSourcesId='{{ kafkaSourcesId }}' --required 
@@json=
'{
