...
<tr><td><b>Id</b></td><td><CopyableCode code="google.cloudkms.locations" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#generate_random_bytes"><CopyableCode code="generate_random_bytes" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a></td>
    <td></td>
    <td>Generate random bytes using the Cloud KMS randomness source in the provided location.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="generate_random_bytes"
    values={[
        { label: 'generate_random_bytes', value: 'generate_random_bytes' }
    ]}
>
<TabItem value="generate_random_bytes">

Generate random bytes using the Cloud KMS randomness source in the provided location.

```sql
EXEC google.cloudkms.locations.generate_random_bytes 
