...
<tr><td><b>Id</b></td><td><CopyableCode code="google.texttospeech.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.texttospeech.operations
...
```sql
EXEC google.texttospeech.operations.cancel 
