...
<tr><td><b>Id</b></td><td><CopyableCode code="google.vmwareengine.clusters_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.vmwareengine.clusters_iam_policies
...
```sql
REPLACE google.vmwareengine.clusters_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.vmwareengine.clusters_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
