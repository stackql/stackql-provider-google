...
<tr><td><b>Id</b></td><td><CopyableCode code="google.cloudscheduler.operations" /></td></tr>
</tbody></table>
...
metadata,
response
FROM google.cloudscheduler.operations
...
```sql
DELETE FROM google.cloudscheduler.operations
WHERE operationsId = '{{ operationsId }}' --required;
```
</TabItem>
</Tabs>
...
```sql
EXEC google.cloudscheduler.operations.cancel 
