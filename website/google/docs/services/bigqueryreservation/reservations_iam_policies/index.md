...
Creates, updates, deletes, gets or lists a <code>reservations_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>reservations_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.bigqueryreservation.reservations_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-reservationsId"><code>reservationsId</code></a></td>
    <td></td>
    <td>Sets an access control policy for a resource. Replaces any existing policy. Supported resources are: - Reservations To call this method, you must have the following Google IAM permissions: - `bigqueryreservation.reservations.setIamPolicy` to set policies on reservations.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-reservationsId"><code>reservationsId</code></a></td>
    <td></td>
    <td>Gets your permissions on a resource. Returns an empty set of permissions if the resource doesn't exist. Supported resources are: - Reservations No Google IAM permissions are required to call this method.</td>
</tr>
</tbody>
</table>
...
members,
role
FROM google.bigqueryreservation.reservations_iam_policies
...
```sql
REPLACE google.bigqueryreservation.reservations_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.bigqueryreservation.reservations_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
