...
Creates, updates, deletes, gets or lists a <code>peerings_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>peerings_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.managedidentities.peerings_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.managedidentities.peerings_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.managedidentities.peerings_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@peeringsId='{{ peeringsId }}' --required 
@@json=
'{
