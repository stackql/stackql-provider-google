...
<tr><td><b>Id</b></td><td><CopyableCode code="google.securitycenter.operations" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="organizations_operations_get"
    values={[
        { label: 'organizations_operations_get', value: 'organizations_operations_get' },
        { label: 'organizations_operations_list', value: 'organizations_operations_list' }
    ]}
>
<TabItem value="organizations_operations_get">
...
<TabItem value="organizations_operations_list">
...
<tbody>
<tr>
    <td><a href="#organizations_operations_get"><CopyableCode code="organizations_operations_get" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-organizationsId"><code>organizationsId</code></a>, <a href="#parameter-operationsId"><code>operationsId</code></a></td>
    <td></td>
...
<tr>
    <td><a href="#organizations_operations_list"><CopyableCode code="organizations_operations_list" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    <td><a href="#organizations_operations_delete"><CopyableCode code="organizations_operations_delete" /></a></td>
...
<tr>
    <td><a href="#organizations_operations_cancel"><CopyableCode code="organizations_operations_cancel" /></a></td>
...
<Tabs
    defaultValue="organizations_operations_delete"
    values={[
        { label: 'organizations_operations_delete', value: 'organizations_operations_delete' }
    ]}
>
<TabItem value="organizations_operations_delete">

Deletes a long-running operation. This method indicates that the client is no longer interested in the operation result. It does not cancel the operation. If the server doesn't support this method, it returns `google.rpc.Code.UNIMPLEMENTED`.

```sql
DELETE FROM google.securitycenter.operations
WHERE organizationsId = '{{ organizationsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
</TabItem>
...
<Tabs
    defaultValue="organizations_operations_cancel"
    values={[
        { label: 'organizations_operations_cancel', value: 'organizations_operations_cancel' }
    ]}
>
<TabItem value="organizations_operations_cancel">

Starts asynchronous cancellation on a long-running operation. The server makes a best effort to cancel the operation, but success is not guaranteed. If the server doesn't support this method, it returns `google.rpc.Code.UNIMPLEMENTED`. Clients can use Operations.GetOperation or other methods to check whether the cancellation succeeded or whether the operation completed despite cancellation. On successful cancellation, the operation is not deleted; instead, it becomes an operation with an Operation.error value with a google.rpc.Status.code of `1`, corresponding to `Code.CANCELLED`.

```sql
EXEC google.securitycenter.operations.organizations_operations_cancel 
