...
<tr><td><b>Id</b></td><td><CopyableCode code="google.webrisk.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Matches the `/v1/&#123;project-name&#125;/operations/&#123;operation-id&#125;` pattern.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>Contains a `SubmitUriMetadata` object.</td>
</tr>
<tr>
...
```sql
DELETE FROM google.webrisk.operations
WHERE projectsId = '{{ projectsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
</TabItem>
...
```sql
EXEC google.webrisk.operations.cancel 
