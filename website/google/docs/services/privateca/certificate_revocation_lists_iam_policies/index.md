...
Creates, updates, deletes, gets or lists a <code>certificate_revocation_lists_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>certificate_revocation_lists_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.privateca.certificate_revocation_lists_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.privateca.certificate_revocation_lists_iam_policies
...
```sql
REPLACE google.privateca.certificate_revocation_lists_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.privateca.certificate_revocation_lists_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@caPoolsId='{{ caPoolsId }}' --required, 
@certificateAuthoritiesId='{{ certificateAuthoritiesId }}' --required, 
@certificateRevocationListsId='{{ certificateRevocationListsId }}' --required 
@@json=
'{
