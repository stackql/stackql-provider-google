...
Creates, updates, deletes, gets or lists a <code>certificate_templates_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>certificate_templates_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.privateca.certificate_templates_iam_policies" /></td></tr>
</tbody></table>
...
```sql
EXEC google.privateca.certificate_templates_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@certificateTemplatesId='{{ certificateTemplatesId }}' --required 
@@json=
'{
