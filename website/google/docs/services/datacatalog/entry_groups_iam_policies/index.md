...
<tr><td><b>Id</b></td><td><CopyableCode code="google.datacatalog.entry_groups_iam_policies" /></td></tr>
</tbody></table>
...
```sql
EXEC google.datacatalog.entry_groups_iam_policies.projects_locations_entry_groups_test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
