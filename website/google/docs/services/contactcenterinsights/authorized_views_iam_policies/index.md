...
<tr><td><b>Id</b></td><td><CopyableCode code="google.contactcenterinsights.authorized_views_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.contactcenterinsights.authorized_views_iam_policies
...
```sql
REPLACE google.contactcenterinsights.authorized_views_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.contactcenterinsights.authorized_views_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
