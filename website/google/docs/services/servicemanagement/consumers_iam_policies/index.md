--- 
title: consumers_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - consumers_iam_policies
  - servicemanagement
  - google
...
Creates, updates, deletes, gets or lists a <code>consumers_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>consumers_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.servicemanagement.consumers_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-servicesId"><code>servicesId</code></a>, <a href="#parameter-consumersId"><code>consumersId</code></a></td>
    <td></td>
...
<tbody>
<tr id="parameter-consumersId">
    <td><CopyableCode code="consumersId" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
...
```sql
REPLACE google.servicemanagement.consumers_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.servicemanagement.consumers_iam_policies.test_iam_permissions 
@servicesId='{{ servicesId }}' --required, 
@consumersId='{{ consumersId }}' --required 
@@json=
'{
