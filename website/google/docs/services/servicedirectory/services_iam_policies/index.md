...
<tr><td><b>Id</b></td><td><CopyableCode code="google.servicedirectory.services_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.servicedirectory.services_iam_policies
...
```sql
EXEC google.servicedirectory.services_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
