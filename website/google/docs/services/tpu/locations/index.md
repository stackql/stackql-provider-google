...
<tr><td><b>Id</b></td><td><CopyableCode code="google.tpu.locations" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#generate_service_identity"><CopyableCode code="generate_service_identity" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a></td>
    <td></td>
    <td>Generates the Cloud TPU service identity for the project.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="generate_service_identity"
    values={[
        { label: 'generate_service_identity', value: 'generate_service_identity' }
    ]}
>
<TabItem value="generate_service_identity">
