...
<tr>
    ...
    <td>Fully qualified domain name of the domain authorized for use. Example: example.com.</td>
</tr>
<tr>
    <td><CopyableCode code="name" /></td>
    <td><code>string</code></td>
    <td>Full path to the AuthorizedDomain resource in the API. Example: apps/myapp/authorizedDomains/example.com.@OutputOnly</td>
</tr>
</tbody>
</table>
</TabItem>
