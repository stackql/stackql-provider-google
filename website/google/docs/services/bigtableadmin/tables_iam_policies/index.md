...
<tr><td><b>Id</b></td><td><CopyableCode code="google.bigtableadmin.tables_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.bigtableadmin.tables_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.bigtableadmin.tables_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
