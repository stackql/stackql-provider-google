...
Creates, updates, deletes, gets or lists a <code>logical_views_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>logical_views_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.bigtableadmin.logical_views_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.bigtableadmin.logical_views_iam_policies
...
```sql
REPLACE google.bigtableadmin.logical_views_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.bigtableadmin.logical_views_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@instancesId='{{ instancesId }}' --required, 
@logicalViewsId='{{ logicalViewsId }}' --required 
@@json=
'{
