...
<tr><td><b>Id</b></td><td><CopyableCode code="google.bigtableadmin.backups_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.bigtableadmin.backups_iam_policies
...
```sql
EXEC google.bigtableadmin.backups_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
