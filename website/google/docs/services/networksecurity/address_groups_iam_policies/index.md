...
Creates, updates, deletes, gets or lists an <code>address_groups_iam_policies</code> resource.
...
<Tabs
    defaultValue="projects_locations_address_groups_get_iam_policy"
    values={[
        { label: 'projects_locations_address_groups_get_iam_policy', value: 'projects_locations_address_groups_get_iam_policy' }
    ]}
>
<TabItem value="projects_locations_address_groups_get_iam_policy">
...
<tbody>
<tr>
    <td><a href="#projects_locations_address_groups_get_iam_policy"><CopyableCode code="projects_locations_address_groups_get_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_address_groups_set_iam_policy"><CopyableCode code="projects_locations_address_groups_set_iam_policy" /></a></td>
...
<Tabs
    defaultValue="projects_locations_address_groups_set_iam_policy"
    values={[
        { label: 'projects_locations_address_groups_set_iam_policy', value: 'projects_locations_address_groups_set_iam_policy' }
    ]}
>
<TabItem value="projects_locations_address_groups_set_iam_policy">

Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.

```sql
REPLACE google.networksecurity.address_groups_iam_policies
SET 
data__policy = '{{ policy }}',
