...
Creates, updates, deletes, gets or lists a <code>workspaces_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>workspaces_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataform.workspaces_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.dataform.workspaces_iam_policies
...
```sql
REPLACE google.dataform.workspaces_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.dataform.workspaces_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
