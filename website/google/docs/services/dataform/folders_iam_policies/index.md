...
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataform.folders_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.dataform.folders_iam_policies
...
```sql
REPLACE google.dataform.folders_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.dataform.folders_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
