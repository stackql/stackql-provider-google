...
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataform.repositories_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.dataform.repositories_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.dataform.repositories_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
