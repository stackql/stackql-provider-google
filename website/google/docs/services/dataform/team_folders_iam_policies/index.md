...
Creates, updates, deletes, gets or lists a <code>team_folders_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>team_folders_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataform.team_folders_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.dataform.team_folders_iam_policies
...
```sql
REPLACE google.dataform.team_folders_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.dataform.team_folders_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@teamFoldersId='{{ teamFoldersId }}' --required 
@@json=
'{
