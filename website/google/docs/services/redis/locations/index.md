...
<tr>
    ...
    <td>Full resource name for the region. For example: "projects/example-project/locations/us-east1".</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Resource ID for the region. For example: "us-east1".</td>
</tr>
<tr>
    <td><CopyableCode code="metadata" /></td>
    <td><code>object</code></td>
    <td>Output only. The set of available zones in the location. The map is keyed by the lowercase ID of each zone, as defined by Compute Engine. These keys can be specified in `location_id` or `alternative_location_id` fields when creating a Redis instance.</td>
</tr>
</tbody>
</table>
</TabItem>
