...
<tr>
    ...
    <td>Name of a workload.</td>
</tr>
<tr>
    <td><CopyableCode code="status" /></td>
    <td><code>object</code></td>
    <td>Output only. Status of a workload. (id: ComposerWorkloadStatus)</td>
</tr>
<tr>
    <td><CopyableCode code="type" /></td>
    <td><code>string</code></td>
    <td>Type of a workload.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Lists workloads in a Cloud Composer environment. Workload is a unit that runs a single Composer component. This method is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.</td>
</tr>
</tbody>
</table>
