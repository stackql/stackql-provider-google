...
Creates, updates, deletes, gets or lists an <code>internal_ranges_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>internal_ranges_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.networkconnectivity.internal_ranges_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.networkconnectivity.internal_ranges_iam_policies
...
```sql
REPLACE google.networkconnectivity.internal_ranges_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.networkconnectivity.internal_ranges_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@internalRangesId='{{ internalRangesId }}' --required 
@@json=
'{
