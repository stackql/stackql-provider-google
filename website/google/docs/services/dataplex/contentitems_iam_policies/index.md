...
Creates, updates, deletes, gets or lists a <code>contentitems_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>contentitems_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataplex.contentitems_iam_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="projects_locations_lakes_contentitems_get_iam_policy"
    values={[
        { label: 'projects_locations_lakes_contentitems_get_iam_policy', value: 'projects_locations_lakes_contentitems_get_iam_policy' }
    ]}
>
<TabItem value="projects_locations_lakes_contentitems_get_iam_policy">
...
<tbody>
<tr>
    <td><a href="#projects_locations_lakes_contentitems_get_iam_policy"><CopyableCode code="projects_locations_lakes_contentitems_get_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_lakes_contentitems_set_iam_policy"><CopyableCode code="projects_locations_lakes_contentitems_set_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_lakes_contentitems_test_iam_permissions"><CopyableCode code="projects_locations_lakes_contentitems_test_iam_permissions" /></a></td>
...
members,
role
FROM google.dataplex.contentitems_iam_policies
...
<Tabs
    defaultValue="projects_locations_lakes_contentitems_set_iam_policy"
    values={[
        { label: 'projects_locations_lakes_contentitems_set_iam_policy', value: 'projects_locations_lakes_contentitems_set_iam_policy' }
    ]}
>
<TabItem value="projects_locations_lakes_contentitems_set_iam_policy">
...
<Tabs
    defaultValue="projects_locations_lakes_contentitems_test_iam_permissions"
    values={[
        { label: 'projects_locations_lakes_contentitems_test_iam_permissions', value: 'projects_locations_lakes_contentitems_test_iam_permissions' }
    ]}
>
<TabItem value="projects_locations_lakes_contentitems_test_iam_permissions">

Returns the caller's permissions on a resource. If the resource does not exist, an empty set of permissions is returned (a NOT_FOUND error is not returned).A caller is not required to have Google IAM permission to make this request.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.

```sql
EXEC google.dataplex.contentitems_iam_policies.projects_locations_lakes_contentitems_test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@lakesId='{{ lakesId }}' --required, 
@contentitemsId='{{ contentitemsId }}' --required 
@@json=
'{
