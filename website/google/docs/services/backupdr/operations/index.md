...
<tr><td><b>Id</b></td><td><CopyableCode code="google.backupdr.operations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a></td>
    <td></td>
    <td>Initializes the service related config for a project.</td>
</tr>
</tbody>
</table>
...
```sql
DELETE FROM google.backupdr.operations
WHERE projectsId = '{{ projectsId }}' --required
AND locationsId = '{{ locationsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
...
```sql
EXEC google.backupdr.operations.cancel 
...
```sql
EXEC google.backupdr.operations.initialize 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required 
@@json=
'{
