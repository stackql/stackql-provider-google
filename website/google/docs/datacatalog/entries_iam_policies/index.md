...
Creates, updates, deletes, gets or lists an <code>entries_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>entries_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.datacatalog.entries_iam_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="projects_locations_entry_groups_entries_get_iam_policy"
    values={[
        { label: 'projects_locations_entry_groups_entries_get_iam_policy', value: 'projects_locations_entry_groups_entries_get_iam_policy' }
    ]}
>
...
<tbody>
<tr>
    <td><a href="#projects_locations_entry_groups_entries_get_iam_policy"><CopyableCode code="projects_locations_entry_groups_entries_get_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_entry_groups_entries_test_iam_permissions"><CopyableCode code="projects_locations_entry_groups_entries_test_iam_permissions" /></a></td>
...
etag,
version
FROM google.datacatalog.entries_iam_policies
...
<Tabs
    defaultValue="projects_locations_entry_groups_entries_test_iam_permissions"
    values={[
        { label: 'projects_locations_entry_groups_entries_test_iam_permissions', value: 'projects_locations_entry_groups_entries_test_iam_permissions' }
    ]}
>
<TabItem value="projects_locations_entry_groups_entries_test_iam_permissions">
...
```sql
EXEC google.datacatalog.entries_iam_policies.projects_locations_entry_groups_entries_test_iam_permissions 
