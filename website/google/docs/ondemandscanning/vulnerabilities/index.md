...
<tr>
    ...
    <td>A page token that can be used in a subsequent call to ListVulnerabilities to continue retrieving results.</td>
</tr>
<tr>
    <td><CopyableCode code="occurrences" /></td>
    <td><code>array</code></td>
    <td>The list of Vulnerability Occurrences resulting from a scan.</td>
</tr>
</tbody>
</table>
</TabItem>
