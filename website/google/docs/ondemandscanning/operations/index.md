...
<tr><td><b>Id</b></td><td><CopyableCode code="google.ondemandscanning.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.ondemandscanning.operations
WHERE projectsId = '{{ projectsId }}' --required
AND locationsId = '{{ locationsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
...
```sql
EXEC google.ondemandscanning.operations.cancel 
...
```sql
EXEC google.ondemandscanning.operations.wait 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@operationsId='{{ operationsId }}' --required, 
@timeout='{{ timeout }}';
