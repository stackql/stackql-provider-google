...
Creates, updates, deletes, gets or lists a <code>region_health_check_services</code> resource.
...
- name: region_health_check_services
  props:
    - name: project
      value: string
      description: Required parameter for the region_health_check_services resource.
    - name: region
      value: string
      description: Required parameter for the region_health_check_services resource.
    - name: kind
