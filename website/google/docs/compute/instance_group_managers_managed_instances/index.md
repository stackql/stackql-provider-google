...
Creates, updates, deletes, gets or lists an <code>instance_group_managers_managed_instances</code> resource.
...
<tr>
    ...
    <td>[Output Only] The list of instances in the managed instance group.</td>
</tr>
<tr>
