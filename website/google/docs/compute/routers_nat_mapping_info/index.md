...
Creates, updates, deletes, gets or lists a <code>routers_nat_mapping_info</code> resource.
...
<Tabs
    defaultValue="get_nat_mapping_info"
    values={[
        { label: 'get_nat_mapping_info', value: 'get_nat_mapping_info' }
    ]}
>
<TabItem value="get_nat_mapping_info">
...
<tr>
    ...
    <td><code>string</code></td>
    <td>[Output Only] Type of resource. Always compute#vmEndpointNatMappingsList for lists of Nat mappings of VM endpoints. (default: compute#vmEndpointNatMappingsList)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>[Output Only] A list of Nat mapping information of VM endpoints.</td>
</tr>
<tr>
