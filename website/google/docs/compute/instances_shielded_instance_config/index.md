...
Creates, updates, deletes, gets or lists an <code>instances_shielded_instance_config</code> resource.
...
<Tabs
    defaultValue="update_shielded_instance_config"
    values={[
...
SET 
data__enableSecureBoot = {{ enableSecureBoot }},
data__enableVtpm = {{ enableVtpm }},
data__enableIntegrityMonitoring = {{ enableIntegrityMonitoring }}
WHERE 
