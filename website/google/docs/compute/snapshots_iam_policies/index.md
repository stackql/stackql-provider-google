...
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.snapshots_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.compute.snapshots_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.compute.snapshots_iam_policies.test_iam_permissions 
@project='{{ project }}' --required, 
