...
keywords:
  - region_instant_snapshots_iam_policies
  - compute
  - google
...
Creates, updates, deletes, gets or lists a <code>region_instant_snapshots_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>region_instant_snapshots_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.region_instant_snapshots_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.compute.region_instant_snapshots_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.compute.region_instant_snapshots_iam_policies.test_iam_permissions 
@project='{{ project }}' --required, 
