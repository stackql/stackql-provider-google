...
<Tabs
    defaultValue="list_preconfigured_expression_sets"
    values={[
        { label: 'list_preconfigured_expression_sets', value: 'list_preconfigured_expression_sets' }
    ]}
>
<TabItem value="list_preconfigured_expression_sets">
...
<tbody>
<tr>
    <td><CopyableCode code="preconfiguredExpressionSets" /></td>
    <td><code>object</code></td>
    <td> (id: SecurityPoliciesWafConfig)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Gets the current list of preconfigured Web Application Firewall (WAF) expressions.</td>
</tr>
</tbody>
</table>
