...
<tr>
    ...
    <td>Retrieves the list of TargetTcpProxy resources available to the specified project.</td>
</tr>
<tr>
    ...
    <td>Creates a TargetTcpProxy resource in the specified project using the data included in the request.</td>
</tr>
<tr>
