...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>instant_snapshots</code></td></tr>
...
<tr>
    <td><CopyableCode code="items" /></td>
    <td><code>object</code></td>
    <td>A list of InstantSnapshotsScopedList resources.</td>
</tr>
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>[Output Only] Type of resource. Always compute#instantSnapshotAggregatedList for aggregated lists of instantSnapshots. (default: compute#instantSnapshotAggregatedList)</td>
</tr>
<tr>
    <td><CopyableCode code="nextPageToken" /></td>
    <td><code>string</code></td>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-zone"><code>zone</code></a>, <a href="#parameter-instantSnapshot"><code>instantSnapshot</code></a></td>
    <td></td>
    <td>Returns the specified InstantSnapshot resource in the specified zone.</td>
</tr>
<tr>
    ...
    <td>Retrieves the list of InstantSnapshot resources contained within the specified zone.</td>
</tr>
<tr>
    ...
    <td>Retrieves an aggregated list of instantSnapshots. To prevent failure, Google recommends that you set the `returnPartialSuccess` parameter to `true`.</td>
</tr>
<tr>
    ...
    <td>Creates an instant snapshot in the specified zone.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-requestId"><code>requestId</code></a></td>
    <td>Sets the labels on a instantSnapshot in the given zone. To learn more about labels, read the Labeling Resources documentation.</td>
</tr>
</tbody>
</table>
