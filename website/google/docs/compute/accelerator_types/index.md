...
Creates, updates, deletes, gets or lists an <code>accelerator_types</code> resource.
...
<tr>
    ...
    <td>[Output Only] The deprecation status associated with this accelerator type. (id: DeprecationStatus)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>[Output Only] The name of the zone where the accelerator type resides, such as us-central1-a. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>A list of AcceleratorType resources.</td>
</tr>
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
...
<tr>
    <td><CopyableCode code="items" /></td>
    <td><code>object</code></td>
    <td>A list of AcceleratorTypesScopedList resources.</td>
</tr>
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>[Output Only] Type of resource. Always compute#acceleratorTypeAggregatedList for aggregated lists of accelerator types. (default: compute#acceleratorTypeAggregatedList)</td>
</tr>
<tr>
    <td><CopyableCode code="nextPageToken" /></td>
    <td><code>string</code></td>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-zone"><code>zone</code></a>, <a href="#parameter-acceleratorType"><code>acceleratorType</code></a></td>
    <td></td>
    <td>Returns the specified accelerator type.</td>
</tr>
<tr>
