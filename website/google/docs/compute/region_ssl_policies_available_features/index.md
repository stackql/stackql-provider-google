...
Creates, updates, deletes, gets or lists a <code>region_ssl_policies_available_features</code> resource.
...
<Tabs
    defaultValue="list_available_features"
    values={[
        { label: 'list_available_features', value: 'list_available_features' }
    ]}
>
