...
<tr>
    ...
    <td><code>string</code></td>
    <td>A page token, received from a previous `ListSynonymSets` call. Provide this to retrieve the subsequent page.</td>
</tr>
<tr>
    <td><CopyableCode code="synonymSets" /></td>
    <td><code>array</code></td>
    <td>The synonymSets from the specified parent.</td>
</tr>
</tbody>
</table>
</TabItem>
