--- 
title: worker_pools_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - worker_pools_iam_policies
  - run
  - google
...
Creates, updates, deletes, gets or lists a <code>worker_pools_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>worker_pools_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.run.worker_pools_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Gets the IAM Access Control policy currently in effect for the given Cloud Run WorkerPool. This result does not include any inherited policies.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-workerPoolsId"><code>workerPoolsId</code></a></td>
    <td></td>
    <td>Sets the IAM Access control policy for the specified WorkerPool. Overwrites any existing policy.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-workerPoolsId"><code>workerPoolsId</code></a></td>
    <td></td>
    <td>Returns permissions that a caller has on the specified Project. There are no permissions required for making this API call.</td>
</tr>
</tbody>
</table>
...
etag,
version
FROM google.run.worker_pools_iam_policies
...
```sql
REPLACE google.run.worker_pools_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.run.worker_pools_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@workerPoolsId='{{ workerPoolsId }}' --required 
@@json=
'{
