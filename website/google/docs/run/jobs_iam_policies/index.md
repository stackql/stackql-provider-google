...
<tr><td><b>Id</b></td><td><CopyableCode code="google.run.jobs_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Gets the IAM Access Control policy currently in effect for the given Job. This result does not include any inherited policies.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-jobsId"><code>jobsId</code></a></td>
    <td></td>
    <td>Sets the IAM Access control policy for the specified Job. Overwrites any existing policy.</td>
</tr>
<tr>
...
```sql
REPLACE google.run.jobs_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.run.jobs_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
