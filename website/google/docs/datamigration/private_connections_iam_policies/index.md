--- 
title: private_connections_iam_policies
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>private_connections_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>private_connections_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.datamigration.private_connections_iam_policies" /></td></tr>
</tbody></table>
...
```sql
REPLACE google.datamigration.private_connections_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.datamigration.private_connections_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@privateConnectionsId='{{ privateConnectionsId }}' --required 
@@json=
'{
