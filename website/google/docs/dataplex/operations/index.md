...
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataplex.operations" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM google.dataplex.operations
WHERE projectsId = '{{ projectsId }}' --required
AND locationsId = '{{ locationsId }}' --required
AND operationsId = '{{ operationsId }}' --required;
```
...
```sql
EXEC google.dataplex.operations.projects_locations_operations_cancel 
...
```sql
EXEC google.dataplex.operations.organizations_locations_operations_cancel 
