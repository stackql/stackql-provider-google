...
Creates, updates, deletes, gets or lists an <code>encryption_configs_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>encryption_configs_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataplex.encryption_configs_iam_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="organizations_locations_encryption_configs_get_iam_policy"
    values={[
        { label: 'organizations_locations_encryption_configs_get_iam_policy', value: 'organizations_locations_encryption_configs_get_iam_policy' }
    ]}
>
...
<tbody>
<tr>
    <td><a href="#organizations_locations_encryption_configs_get_iam_policy"><CopyableCode code="organizations_locations_encryption_configs_get_iam_policy" /></a></td>
...
<tr>
    <td><a href="#organizations_locations_encryption_configs_set_iam_policy"><CopyableCode code="organizations_locations_encryption_configs_set_iam_policy" /></a></td>
...
<tr>
    <td><a href="#organizations_locations_encryption_configs_test_iam_permissions"><CopyableCode code="organizations_locations_encryption_configs_test_iam_permissions" /></a></td>
...
<Tabs
    defaultValue="organizations_locations_encryption_configs_set_iam_policy"
    values={[
        { label: 'organizations_locations_encryption_configs_set_iam_policy', value: 'organizations_locations_encryption_configs_set_iam_policy' }
    ]}
>
<TabItem value="organizations_locations_encryption_configs_set_iam_policy">
...
<Tabs
    defaultValue="organizations_locations_encryption_configs_test_iam_permissions"
    values={[
        { label: 'organizations_locations_encryption_configs_test_iam_permissions', value: 'organizations_locations_encryption_configs_test_iam_permissions' }
    ]}
>
<TabItem value="organizations_locations_encryption_configs_test_iam_permissions">

Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.

```sql
EXEC google.dataplex.encryption_configs_iam_policies.organizations_locations_encryption_configs_test_iam_permissions 
@organizationsId='{{ organizationsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@encryptionConfigsId='{{ encryptionConfigsId }}' --required 
@@json=
'{
