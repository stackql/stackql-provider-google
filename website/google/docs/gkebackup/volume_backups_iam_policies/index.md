...
Creates, updates, deletes, gets or lists a <code>volume_backups_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>volume_backups_iam_policies</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.gkebackup.volume_backups_iam_policies" /></td></tr>
</tbody></table>
...
etag,
version
FROM google.gkebackup.volume_backups_iam_policies
...
```sql
REPLACE google.gkebackup.volume_backups_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.gkebackup.volume_backups_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@backupPlansId='{{ backupPlansId }}' --required, 
@backupsId='{{ backupsId }}' --required, 
@volumeBackupsId='{{ volumeBackupsId }}' --required 
@@json=
'{
