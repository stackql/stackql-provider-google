...
<tr><td><b>Id</b></td><td><CopyableCode code="google.gkebackup.backups_iam_policies" /></td></tr>
</tbody></table>
...
etag,
version
FROM google.gkebackup.backups_iam_policies
...
```sql
REPLACE google.gkebackup.backups_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.gkebackup.backups_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
